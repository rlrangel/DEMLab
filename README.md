...
The code of all OOP classes of the program is documented in HTML files,
generated by the MATLAB _Publish_ command and located inside the folder [*html*][html_folder_link].
These files can be browsed on the [Wiki page][wiki_link].
