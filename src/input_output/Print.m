...
%% Description
%
% This is a handle class responsible for printing the required results of
% a certain step.
%
% In each printing step, a different output file with a _.pos_ extension is
% created to print the results.
%
